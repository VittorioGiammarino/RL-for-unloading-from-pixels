...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 30 11:01:53 2022
...
COMMON_TRAIN_FORMAT = [('step', 'S', 'int'), ('loss', 'Loss', 'float')]

COMMON_EVAL_FORMAT = [('step', 'S', 'int'), ('expert_reward', 'ER', 'float'), ('agent_reward', 'AR', 'float')]
